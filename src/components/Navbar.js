...
const Navbar = () => {
  ...
  return (
    <div className='sticky z-30 bottom-0 bg-gray-800 overflow-hidden'>
      <div className='flex w-full h-full justify-around text-center items-center text-white '>
        <NavLink to='/'
          onClick={handleNavLinkClick}
          className={({ isActive }) => (isActive ? activeLink : normalLink)}>
          <FontAwesomeIcon icon={faHome} />
          <span className='text-lg pl-2'>Home</span>
        </NavLink>
        ...
        <NavLink to='movies'
          ...
          <span className='text-lg pl-2'>Movies</span>
        </NavLink>
        ...
        <NavLink to='series'
          ...
          <span className='text-lg pl-2'>TV Series</span>
        </NavLink>
      </div>
